...
if ( ! class_exists( 'SPTV_Gamajo_Template_Loader' ) ) {
	 ...
	 *
	 * When using in a plugin, create a new class SPTV_that extends this one and just overrides the properties.
	 *
	 * @package Gamajo_Template_Loader
	 * @author  Gary Jones
	 */
	class SPTV_Gamajo_Template_Loader {
		/**
