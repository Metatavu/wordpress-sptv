...
import Icon from "./printable-form-service-channel-icon";
import PrintableFormServiceChannelComponent from './components/printable-form-service-channel-component';
 ...
 */
registerBlockType('sptv/printable-form-service-channel-block', {
  title: __( 'Printable form service channel', 'sptv' ),
  icon: Icon,
  category: 'sptv',
  ...
  edit: ((params: WPBlockTypeEditParams) => {
    ...
    if (!getAttribute("component")) {
      setAttribute("component", sptv.printableFormServiceChannelBlock.components ? sptv.printableFormServiceChannelBlock.components[0].slug : null);
    }
