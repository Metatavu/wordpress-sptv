...
import Icon from "./electronic-service-channel-icon";
import ElectronicServiceChannelComponent from './components/electronic-service-channel-component';
 ...
 */
registerBlockType('sptv/electronic-service-channel-block', {
  title: __( 'Electronic service channel', 'sptv' ),
  icon: Icon,
  category: 'sptv',
  ...
  edit: ((params: WPBlockTypeEditParams) => {
    ...
    if (!getAttribute("component")) {
      setAttribute("component", sptv.electronicServiceChannelBlock.components ? sptv.electronicServiceChannelBlock.components[0].slug : null);
    }
    ...
    return <ElectronicServiceChannelComponent 
      editing={ isSelected } 
